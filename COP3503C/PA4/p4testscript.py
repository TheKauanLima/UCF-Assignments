...
def compilerunfile():
    ...
    javac = "javac " + cwd + "/DroneDeliveryDriver.java" #compile solution file command and generate class file

    proc = subprocess.run([javac], capture_output=True, text = True, shell = True)
    

    
    java = "java DroneDeliveryDriver"
...
def main():
    ...
    subprocess.run(["rm DroneDeliveryDriver.class"], capture_output=True, text = True, shell = True)
    subprocess.run(["rm DroneDelivery.class"], capture_output=True, text = True, shell = True)
