...
def compilerunfile():
    ...
    javac = "javac " + cwd + "/NetworkPacketDriver.java" #compile solution file command and generate class file

    proc = subprocess.run([javac], capture_output=True, text = True, shell = True)
    

    
    java = "java NetworkPacketDriver"
...
def main():
    ...
    subprocess.run(["rm NetworkPacketDriver.class"], capture_output=True, text = True, shell = True)
    subprocess.run(["rm NetworkPacket.class"], capture_output=True, text = True, shell = True)
