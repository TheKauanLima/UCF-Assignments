...
def compilerunfile():
    ...
    javac = "javac " + cwd + "/MountainDriver.java" #compile solution file command and generate class file

    proc = subprocess.run([javac], capture_output=True, text = True, shell = True)
    

    
    java = "java MountainDriver"
...
def main():
    ...
    subprocess.run(["rm MountainDriver.class"], capture_output=True, text = True, shell = True)
    subprocess.run(["rm Mountain.class"], capture_output=True, text = True, shell = True)
