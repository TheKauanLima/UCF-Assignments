...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "gatti", 0) >= 0)
        {
            response = "He sounds like a good professor.";
        }
        else if (findKeyword(statement, "joslin", 0) >= 0)
        {
            response = "She sounds like a good teacher.";
        }
        else if (findKeyword(statement, "tv", 0) >= 0)
        {
            response = "I like watching TV, what's your favorite movie?";
        }
        else if (findKeyword(statement, "eat", 0) >= 0)
        {
            response = "I like to eat nachos.";
        }
        else if (findKeyword(statement, "drink", 0) >= 0)
        {
            response = "I drink coffee a lot in the mornings.";
        }
        else
        {
